...
data_to_export <- 
  ...
  mutate(Any_Self_Cancelled_Appt_T1 = (adh_cancer_you_T1 == "Yes" | adh_cancer_test_who_T1 == "Me"),
         ...
         Any_Provider_Cancelled_Appt_T1 = (adh_cancer_apt_T1 == "Yes" | adh_cancer_test_who_T1 == "My healthcare provider"),
         Any_Provider_Cancelled_Appt_T2 = (adh_cancer_apt_T2 == "Yes" | adh_cancer_test_who_T2 == "My healthcare provider"),
         Any_Provider_Cancelled_Appt_T3 = (adh_cancer_apt_T3 == "Yes" | adh_cancer_test_who_T3 == "My healthcare provider"))
...
data_to_export %>%
  select(Any_Provider_Cancelled_Appt_T1, adh_cancer_test_who_T1, adh_cancer_apt_T1) %>%
  filter(adh_cancer_test_who_T1 == "My healthcare provider") %>%
  arrange(Any_Provider_Cancelled_Appt_T1)
...
data_to_export %>%
  select(Any_Provider_Cancelled_Appt_T2, adh_cancer_test_who_T2, adh_cancer_apt_T2) %>%
  filter(adh_cancer_test_who_T2 == "My healthcare provider") %>%
  arrange(Any_Provider_Cancelled_Appt_T2)
