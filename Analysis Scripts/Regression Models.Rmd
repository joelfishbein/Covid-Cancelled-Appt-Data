...
Lauren - my best guess is the below is just code you needed to run once? If so recommend delete now that it works :)
...
write_rds(multi1, here('Model fits','multi1.rds'))
write_rds(multi2, here('Model fits','multi2.rds'))
write_rds(multi3, here('Model fits','multi3.rds'))
