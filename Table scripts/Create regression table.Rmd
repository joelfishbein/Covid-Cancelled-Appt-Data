...
multiple_predictor.table <- tibble( models = 
                                      list(getModel('multi1.rds'),
                                           getModel('multi2.rds'),
                                           getModel('multi3.rds'))) %>%
...
joined_table <- left_join(x = single_predictor.table, y = multiple_predictor.table, by = 'term')
...
joined_table %>%
  ...
  add_header_above(c(" " = 1, "Single Predictor Models" = 3, "Multiple Predictor Models" = 3))
